...
--
-- Name: orders_ins(); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.orders_ins() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
begin
if new.price > 499
...
ALTER FUNCTION public.orders_ins() OWNER TO postgres;
...
--
-- Name: orders orders_title_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: orders orders_title_key1; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.orders
    ADD CONSTRAINT orders_title_key1 UNIQUE (title);


--
-- Name: orders price_part_ins; Type: TRIGGER; Schema: public; Owner: postgres
--

CREATE TRIGGER price_part_ins BEFORE INSERT ON public.orders FOR EACH ROW EXECUTE FUNCTION public.orders_ins();
